package br.com.imarui.authentication.api.http.controller.admin;

import br.com.imarui.authentication.api.http.dto.recovery.AdminPasswordRecoveryRequestResponseDTO;
import br.com.imarui.authentication.api.http.dto.recovery.PasswordResetLinkAdminResponseDTO;
import br.com.imarui.authentication.api.http.dto.recovery.TemporaryPasswordAdminResponseDTO;
import br.com.imarui.authentication.core.application.result.PasswordResetLinkAdminResult;
import br.com.imarui.authentication.core.application.result.TemporaryPasswordAdminResult;
import br.com.imarui.authentication.core.application.result.admin.recovery.AdminPasswordRecoveryRequestResult;
import br.com.imarui.authentication.core.application.service.passwordrecovery.AdminPasswordRecoveryService;
import br.com.imarui.platform.openapi.group.SwaggerOperationGroup;
import br.com.imarui.platform.openapi.security.RequiredPermission;
...
public class AdminPasswordRecoveryRequestController {
    ...
    public ResponseEntity<List<AdminPasswordRecoveryRequestResponseDTO>> findAll() {
        List<AdminPasswordRecoveryRequestResult> results =
                adminPasswordRecoveryService.findAll();
    ...
    public ResponseEntity<AdminPasswordRecoveryRequestResponseDTO> findById(
        ...
        AdminPasswordRecoveryRequestResult result =
                adminPasswordRecoveryService.findById(requestId);
    ...
    public ResponseEntity<List<AdminPasswordRecoveryRequestResponseDTO>> findByUserId(
        ...
        List<AdminPasswordRecoveryRequestResult> results =
                adminPasswordRecoveryService.findByUserId(userId);
    ...
    public ResponseEntity<AdminPasswordRecoveryRequestResponseDTO> cancel(
        ...
        AdminPasswordRecoveryRequestResult result =
                adminPasswordRecoveryService.cancel(requestId);
    ...
    public ResponseEntity<TemporaryPasswordAdminResponseDTO> generateTemporaryPassword(
        ...
        TemporaryPasswordAdminResult result =
                adminPasswordRecoveryService.generateTemporaryPassword(userId);
    ...
    public ResponseEntity<PasswordResetLinkAdminResponseDTO> generateResetLink(
        ...
        PasswordResetLinkAdminResult result =
                adminPasswordRecoveryService.generateResetLink(userId);
