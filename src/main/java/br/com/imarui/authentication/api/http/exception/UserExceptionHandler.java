...
import br.com.imarui.authentication.core.application.exceptions.user.UserCpfInvalidException;
import br.com.imarui.authentication.core.application.exceptions.user.UserDisabledException;
import br.com.imarui.authentication.core.application.exceptions.user.UserIdNotFoundException;
import br.com.imarui.authentication.core.domain.exception.user.UserAlreadyDisabledException;
import br.com.imarui.authentication.core.domain.exception.user.UserBlockedForLoginException;
import br.com.imarui.authentication.core.domain.exception.user.UserCannotChangePasswordException;
import br.com.imarui.authentication.core.domain.exception.user.UserIdRequiredException;
import br.com.imarui.authentication.core.domain.exception.user.UserLockoutException;
import br.com.imarui.authentication.core.domain.exception.user.UserNewHashRequiredException;
import br.com.imarui.authentication.core.domain.exception.user.UserNotDisabledException;
import br.com.imarui.authentication.core.domain.exception.user.UserNotLockoutException;
import br.com.imarui.authentication.core.domain.exception.user.UserNowInstantRequiredException;
import br.com.imarui.authentication.core.domain.exception.user.UserPasswordChangeRequiredException;
