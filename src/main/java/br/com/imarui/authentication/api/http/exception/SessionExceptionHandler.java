...
import br.com.imarui.authentication.core.application.exceptions.session.SessionInvalidException;
...
import br.com.imarui.authentication.core.domain.exception.session.SessionInvalidActiveStateException;
import br.com.imarui.authentication.core.domain.exception.session.SessionInvalidExpirationDateException;
import br.com.imarui.authentication.core.domain.exception.session.SessionInvalidLogoutStateException;
import br.com.imarui.authentication.core.domain.exception.session.SessionInvalidRevokeStateException;
import br.com.imarui.authentication.core.domain.exception.session.SessionInvalidTtlValueException;
import br.com.imarui.authentication.core.domain.exception.session.SessionMissingCreatedAtException;
import br.com.imarui.authentication.core.domain.exception.session.SessionMissingExpiresAtException;
import br.com.imarui.authentication.core.domain.exception.session.SessionMissingIdException;
import br.com.imarui.authentication.core.domain.exception.session.SessionMissingStatusException;
import br.com.imarui.authentication.core.domain.exception.session.SessionMissingTtlException;
import br.com.imarui.authentication.core.domain.exception.session.SessionMissingUserIdException;
import br.com.imarui.authentication.core.domain.exception.session.SessionNotActiveException;
import br.com.imarui.authentication.core.domain.exception.session.SessionNowInstantRequiredException;
