package br.com.imarui.authentication.core.application.service.session;

import br.com.imarui.authentication.core.application.exceptions.login.InvalidCredentialsException;
import br.com.imarui.authentication.core.application.exceptions.login.PasswordChangeChallengeInvalidException;
import br.com.imarui.authentication.core.application.exceptions.login.PasswordRecoveryRequestNotFoundException;
import br.com.imarui.authentication.core.application.exceptions.session.SessionNotFoundException;
import br.com.imarui.authentication.core.application.exceptions.session.SessionUserMismatchException;
import br.com.imarui.authentication.core.application.exceptions.user.UserIdNotFoundException;
import br.com.imarui.authentication.core.application.exceptions.user.UserPasswordChangeNotRequiredException;
import br.com.imarui.authentication.core.application.result.AuthTokens;
import br.com.imarui.authentication.core.application.result.MeResult;
import br.com.imarui.authentication.core.application.result.login.AuthenticatedLoginResult;
import br.com.imarui.authentication.core.application.result.login.LoginResult;
import br.com.imarui.authentication.core.application.service.internal.CredentialRevocationService;
import br.com.imarui.authentication.core.application.service.internal.PasswordChangeChallengeIssuer;
import br.com.imarui.authentication.core.application.service.internal.TokenIssuanceService;
...
import br.com.imarui.authentication.core.repository.PasswordChangeChallengeRepository;
import br.com.imarui.authentication.core.repository.PasswordRecoveryRequestRepository;
import br.com.imarui.authentication.core.repository.RefreshTokenRepository;
import br.com.imarui.authentication.core.repository.SessionRepository;
