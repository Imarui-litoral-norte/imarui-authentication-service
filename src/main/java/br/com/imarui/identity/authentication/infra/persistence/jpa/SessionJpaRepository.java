package br.com.imarui.identity.authentication.infra.persistence.jpa;

import br.com.imarui.identity.authentication.core.domain.enums.SessionStatus;
import br.com.imarui.identity.authentication.infra.persistence.entity.SessionEntity;
...
public interface SessionJpaRepository
    ...
    @Query("""
            ...
            SET session.status =
                br.com.imarui.authentication.core.domain.enums.SessionStatus.REVOKED
            WHERE session.userId = :userId
              AND session.status =
                br.com.imarui.authentication.core.domain.enums.SessionStatus.ACTIVE
            """)
