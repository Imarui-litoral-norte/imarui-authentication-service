...
import br.com.imarui.identity.identity.core.application.command.tenant.DisableTenantCommand;
...
public class DisableTenantUseCase {
    ...
    @Transactional
    public TenantResult execute(DisableTenantCommand command) {
